# Landing Page
O Landing Page é uma proposta de projeto  para criar uma versão simplificada de um site (Landing Page).Os conteúdos principais  a serem estudados são:
...
# Enunciado
O objetivo desse exercício é desenvolver uma Landing Page para uma das empresas fictícias apresentadas. 

A Landing Page é a primeira página de um site institucional e deve ser atrativa para os clientes, fornecendo informações sobre a empresa e seus produtos. 

As empresas fictícias vão desde um banco digital a uma empresa de seguros, passando por um serviço de aluguel de repúblicas para estudantes universitários e uma plataforma de crédito para empreendedores de periferia. 

É importante que a página seja criada com criatividade, sem se limitar às características fornecidas sobre as empresas fictícias. Para ajudar na construção da página, foram disponibilizadas referências de outras Landing Pages que podem ser utilizadas como inspiração.
...
- [ ] **Redes Sociais:** Incluir pelo menos  2 ícones para suas redes sociais,visíveis e clicáveis.	
...
- [ ] **Botões:** Todos os botões devem estar funcionando com alguma logica javascript.	
